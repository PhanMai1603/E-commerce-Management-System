      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Xác nhận hoàn tiền</h1>
              <p className="text-sm text-gray-500 mt-1">
                Mã yêu cầu hoàn tiền: <span className="font-mono bg-gray-100 px-2 py-1 rounded text-gray-800">{refundLogId}</span>
              </p>
        ...
        {!result && (
          <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
           <h2 className="text-xl font-semibold text-gray-900 mb-4">Chọn phương thức hoàn tiền</h2>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-lg font-medium text-gray-900">Chuyển khoản ngân hàng</span>
                    </div>
                  </div>
                </div>
              </div>
...
<h4 className="text-lg font-medium text-gray-900 mb-4">Thông tin ngân hàng nhận hoàn tiền</h4>
