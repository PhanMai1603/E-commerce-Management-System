  ...
  const handleImageChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      if (file.size > maxSize) {
        toast.error("Kích thước tệp vượt quá 2MB.");
        return;
      }
      if (!allowedTypes.includes(file.type)) {
        toast.error("Vui lòng chọn tệp hình ảnh hợp lệ (JPEG, PNG, GIF).");
        return;
      }
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      if (response.image_url) {
        ...
        toast.error("Tải ảnh đại diện không thành công.");
      }
    } catch {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Chọn một bức ảnh đại diện cho bạn tốt nhất</p>
        </div>
              ...
              {imageSrc ? (
                <div className="relative">
                  ...
                  <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2">
                    <div className="bg-white rounded-full px-4 py-2 shadow-lg border">
                      <p className="text-sm text-gray-600">Kéo để điều chỉnh • Cuộn để phóng to</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative group">
                  ...
                  <div className="absolute inset-0 rounded-full bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                    <p className="text-white text-sm font-medium">Avatar hiện tại</p>
                  </div>
                </div>
              ) : (
            ...
            {imageSrc && (
              <div className="flex justify-center">
                <div className="bg-white rounded-full px-6 py-3 shadow-lg border flex items-center space-x-4">
                  <span className="text-sm text-gray-600">Phóng:</span>
                  <input
                    type="range"
                    min={1}
                    max={3}
              ...
              <div className="mb-8 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 border border-blue-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-xs text-gray-500 uppercase tracking-wide">Tên</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="relative">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  Hỗ trợ JPEG, PNG, GIF lên đến 2MB
                </p>
              </div>
